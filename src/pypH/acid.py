...
class Acid:
    ...
    def total_concentration(self) -> float:
        """
        The total concentration of the acid species. In general terms it represents
        the sum of all the species generated by the dissociation of the acid itself.

        Returns
        -------
        float
            The total concentration of the acid in (mol/L).
        """
        return self.__Ca
